...
def feature_transform(train_file, words, tags, chunk_tags, words_len, tags_len, chunk_tags_len):
...
model = LinearSVC()
X_train, y_train = feature_transform(train_file, words, tags, chunk_tags, words_len, tags_len, chunk_tags_len)
model.fit(X_train, y_train)
pred_train = model.predict(X_train)
print(classification_report(y_train, pred_train))

X_test, y_test = feature_transform(test_file, words, tags, chunk_tags, words_len, tags_len, chunk_tags_len)
